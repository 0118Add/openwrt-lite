...
# openwrt repo
OPENWRT_REPO=0118Add/openwrt-lite
...
# openwrt feeds
git clone https://$github/0118Add/YAOF master/base-23.05 -b base-23.05 --depth=1
git clone https://$github/0118Add/YAOF master/extd-23.05 -b extd-23.05 --depth=1
git clone https://$github/0118Add/YAOF master/lite-23.05 -b lite-23.05 --depth=1
git clone https://$github/0118Add/YAOF master/archive-23.05 -b archive-23.05 --depth=1
